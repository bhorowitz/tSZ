        double precision function rombint2(f,a,b,tol,v1,rvir)
...
c
c  2 free variable, v1,rvir, can be passed to the function.
c
...
c
        h=0.5d0*(b-a)
        gmax=h*(f(a,v1,rvir)+f(b,v1,rvir))
        g(1)=gmax
        nint=1
        error=1.0d20
        i=0
